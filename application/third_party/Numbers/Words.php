...
class Numbers_Words
{
     ...
     *                         current loaded driver or fr if any.
     ...
     *
     * @param string $locale   Language name abbreviation. Optional. Defaults to fr.
     *
     ...
     * @return string
     */
    function toCurrency($num, $locale = 'fr', $intCurr = '', $decimalPoint = null)
    {
        $ret = $num;
     ...
     *
     * @param string $locale         Locale key, e.g. "de" or "fr"
